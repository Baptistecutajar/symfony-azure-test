...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    Site(variables: SiteQueryVariables, requestHeaders?: GraphQLClientRequestHeaders): Promise<SiteQuery> {
      return withWrapper((wrappedRequestHeaders) => client.request<SiteQuery>(SiteDocument, variables, {...requestHeaders, ...wrappedRequestHeaders}), 'Site', 'query');
    }
  };
}
